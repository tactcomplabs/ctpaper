...
plot  './raspi3/STRIDE1_ADD.txt' using 1:3 with linespoints title 'Cortex-A53 ADD',\
      ...
      './other/arm/STRIDE1_ADD.txt' using 1:3 with linespoints title 'Cavium ThunderX2 ADD',\
      './other/arm/STRIDE1_CAS.txt' using 1:3 with linespoints title 'Cavium ThunderX2 CAS',\
