...
plot  './raspi3/GATHER_ADD.txt' using 1:3 with linespoints title 'Cortex-A53 ADD',\
      ...
      './other/arm/GATHER_ADD.txt' using 1:3 with linespoints title 'Cavium ThunderX2 ADD',\
      './other/arm/GATHER_CAS.txt' using 1:3 with linespoints title 'Cavium ThunderX2 CAS',\
