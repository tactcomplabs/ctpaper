...
plot  './raspi3/SCATTER_ADD.txt' using 1:3 with linespoints title 'Cortex-A53 ADD',\
      ...
      './other/arm/SCATTER_ADD.txt' using 1:3 with linespoints title 'Cavium ThunderX2 ADD',\
      './other/arm/SCATTER_CAS.txt' using 1:3 with linespoints title 'Cavium ThunderX2 CAS',\
