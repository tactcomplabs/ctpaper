...
\todo{If you may need more space, the related work section can be cut to be more concise, but still keep a copy of complete writing in case needed later on. -Yong}