...
plot  './raspi3/PTRCHASE_ADD.txt' using 1:3 with linespoints linestyle 1 title 'Cortex-A53 ADD',\
      './raspi3/PTRCHASE_CAS.txt' using 1:3 with linespoints linestyle 2 title 'Cortex-A53 CAS',\
      './raspi4/PTRCHASE_ADD.txt' using 1:3 with linespoints linestyle 3 title 'Cortex-A72 ADD',\
      './raspi4/PTRCHASE_CAS.txt' using 1:3 with linespoints linestyle 4 title 'Cortex-A72 CAS',\
      './ryzen1/PTRCHASE_ADD.txt' using 1:3 with linespoints linestyle 5 title 'Ryzen V1605B ADD',\
      './ryzen1/PTRCHASE_CAS.txt' using 1:3 with linespoints linestyle 6 title 'Ryzen V1605B CAS',\
      './centos7build02/PTRCHASE_ADD.txt' using 1:3 with linespoints linestyle 7 title 'Opteron 4130 ADD',\
      './centos7build02/PTRCHASE_CAS.txt' using 1:3 with linespoints linestyle 8 title 'Opteron 4130 CAS',\
      './osxbuild01/PTRCHASE_ADD.txt' using 1:3 with linespoints linestyle 9 title 'Core i5-3210M ADD',\
      './osxbuild01/PTRCHASE_CAS.txt' using 1:3 with linespoints linestyle 10 title 'Core i5-3210M CAS',\
      './i7-3930K/PTRCHASE_ADD.txt' using 1:3 with linespoints linestyle 11 title 'Core i7-3930K ADD',\
      './i7-3930K/PTRCHASE_CAS.txt' using 1:3 with linespoints linestyle 12 title 'Core i7-3930K CAS',\
      './i7-4980HQ/PTRCHASE_ADD.txt' using 1:3 with linespoints linestyle 13 title 'Core i7-4980HQ ADD',\
      './i7-4980HQ/PTRCHASE_CAS.txt' using 1:3 with linespoints linestyle 14 title 'Core i7-4980HQ CAS',\
      './other/knl/PTRCHASE_ADD.txt' using 1:3 with linespoints linestyle 15 title 'Xeon Phi 7250 ADD',\
      './other/knl/PTRCHASE_CAS.txt' using 1:3 with linespoints linestyle 16 title 'Xeon Phi 7250 CAS',\
      './lnxbuild02/PTRCHASE_ADD.txt' using 1:3 with linespoints linestyle 17 title 'Xeon E5620 ADD',\
      './lnxbuild02/PTRCHASE_CAS.txt' using 1:3 with linespoints linestyle 18 title 'Xeon E5620 CAS',\
      './lnxbuild01/PTRCHASE_ADD.txt' using 1:3 with linespoints linestyle 19 title 'Xeon X5650 ADD',\
      './lnxbuild01/PTRCHASE_CAS.txt' using 1:3 with linespoints linestyle 20 title 'Xeon X5650 CAS',\
      './gc64/PTRCHASE_ADD.txt' using 1:3 with linespoints linestyle 21 title 'Xeon E5-2620 v3 ADD',\
      './gc64/PTRCHASE_CAS.txt' using 1:3 with linespoints linestyle 22 title 'Xeon E5-2620 v3 CAS',\
      './hrothgar-ivy/PTRCHASE_ADD.txt' using 1:3 with linespoints linestyle 23 title 'Xeon E5-2670 v2 ADD',\
      './hrothgar-ivy/PTRCHASE_CAS.txt' using 1:3 with linespoints linestyle 24 title 'Xeon E5-2670 v2 CAS',\
      './quanah/PTRCHASE_ADD.txt' using 1:3 with linespoints linestyle 25 title 'Xeon E5-2695 v4 ADD',\
      './quanah/PTRCHASE_CAS.txt' using 1:3 with linespoints linestyle 26 title 'Xeon E5-2695 v4 CAS',\
      './other/xeon_haswell/PTRCHASE_ADD.txt' using 1:3 with linespoints linestyle 27 title 'Xeon E5-2698 v3 ADD',\
      './other/xeon_haswell/PTRCHASE_CAS.txt' using 1:3 with linespoints linestyle 28 title 'Xeon E5-2698 v3 CAS'
...
plot  './other/knl/PTRCHASE_ADD.txt' using 1:3 with linespoints linestyle 15 title 'Xeon Phi 7250 ADD',\
      './other/knl/PTRCHASE_CAS.txt' using 1:3 with linespoints linestyle 16 title 'Xeon Phi 7250 CAS',\
      './lnxbuild01/PTRCHASE_ADD.txt' using 1:3 with linespoints linestyle 19 title 'Xeon X5650 ADD',\
      './lnxbuild01/PTRCHASE_CAS.txt' using 1:3 with linespoints linestyle 20 title 'Xeon X5650 CAS',\
      './gc64/PTRCHASE_ADD.txt' using 1:3 with linespoints linestyle 21 title 'Xeon E5-2620 v3 ADD',\
